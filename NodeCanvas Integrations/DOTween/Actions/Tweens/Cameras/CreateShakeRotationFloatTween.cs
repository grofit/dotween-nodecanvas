...
namespace NodeCanvas.Tasks.DOTween.Tweens.Cameras
{
    ...
    [Name("Create Shake Rotation Tween (Float Strength)")]
    [Description("Creates a shake rotation tween with float strength for configuration or use")]
    [Icon("DOTweenTween")]
    [AgentType(typeof(Camera))]
    public class CreateShakeRotationFloatTween : ActionTask
    {
